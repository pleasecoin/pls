...
const string strMessageMagic = "pleasecoin Signed Message:\n";
...
static const int64 nTargetTimespan = 3.5 * 24 * 60 * 60; // pleasecoin: 3.5 days
static const int64 nTargetSpacing = 2.5 * 60; // pleasecoin: 2.5 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal pleasecoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "pleasecoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xe96e264b6381c875b7b5701146ee2b4c35e7d23ab2c66b5dfc2ad601bf992599");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1388625571; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1345972;

        if (fTestNet)
        {
            block.nTime    = 1388625571;
            block.nNonce   = 644305;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xc711fa831e78a01820e09aa211cf9507360e8fbcc36d69243e55af74d1f1d0fb"));
